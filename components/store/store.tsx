...
const Store = () => {
  return (
    <div className='store_container w-full flex flex-row h-[1080px]'>
      <div className='store_btn bg-grmk-mini'>
        <StoreDetail
          title='MINI'
      ...
      <div className='store_btn bg-grmk-kitchen'>
        <StoreDetail
          title='KITCHEN'
          desc='합리적인 가격에<br/> 고퀄리티 오마카세<br/> 최고의 맛과<br/> 경험을 드리는<br/> 키친'
          text='수산물의 다양함과 화려함은 무궁무진한 맛과 경험을 제공합니다.<br/>30년 이상의 경력을 가진 셰프들과 치열하게 연구하고 개발하여<br/>직접 유통하는 최고급 원물의 맛과 즐거움을 고객님들께<br/>선물하고 싶습니다.<br/><br/>보다 맛있게, 보다 합리적으로<br/>찾아주시는 여러분들을 정성을 다해 모시겠습니다. '
        />
      </div>
      <div className='store_btn bg-grmk-place'>
        <StoreDetail
          title='PLACE'
